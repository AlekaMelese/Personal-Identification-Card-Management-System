...
<form action="Searching_resident.php" method="GET">    
	<tr>
...
<legend align="center">List of ID Card Recived Residents:</legend>
<?php
...
//if($conn) mysqli_select_db($conn,'picms') or die("Could not select database");
	...
	//$text=$_GET["text1"];
	$sql=mysqli_query($conn,"SELECT * FROM `resident` WHERE Status='Recived' ");
	...
	echo"</table>";	
	 $result = mysqli_query($conn,"select count(1) FROM  `resident` WHERE Status='Recived'");
$row = mysqli_fetch_array($result);

$total = $row[0];
echo "Total ID Recived Residents= " . $total.".";
?>
</fieldset>
<br><br><br><br><br>	
	  <div id="content">
