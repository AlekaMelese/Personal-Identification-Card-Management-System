...
<fieldset style="max-width:450%; ">
<legend align="center"><b> Feedbacks forward from users:</b></legend>
<?php
...
//if($conn) mysqli_select_db($conn,'picms') or die("Could not select database");
	...
	echo"<table border='1' style='margin-left: 10px;'align='center'><tr style='background-color: silver;font-size: 15.5px;height: 30px;'><th>Id</th><th>Name</th><th> Email</th><th>Comment</th><th>Date</th><th>Delete</th></tr>";
	while($test=mysqli_fetch_array($sql)){			 
				...
				echo"<td> <a href ='DeleteFeedBack.php?IDNo=$id'>Delete</a>";
				echo "</tr>";
		 ?>
