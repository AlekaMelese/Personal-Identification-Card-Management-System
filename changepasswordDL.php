...
<div id="main">
					...
					<form method="post" name="changepasswordDL" action="changepasswordDL.php">
	 ...
	 $OldPassword=$NewPassword=$ConfirmPassword=$OldPasswordE=$NewPasswordE=$ConfirmPasswordE="";
			if($_SERVER["REQUEST_METHOD"]=="POST")
			{
				if(empty($_POST["OldPassword"])) 
				{
					...
					if(!preg_match("/^[a-zA-Z ]+$/",$_POST["OldPassword"])){
...
?>
					...
					<form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">	
						...
						<tr><td>
						New Password:</td><td><input type="password" name="newPass"  ID="newPass"> 
						<span class="message" style="color:red;">*<?php echo $NewPasswordE; ?></span>
						</td></tr><tr><td>
						Verify New Password:</td><td><input type="password"   ID="New"> 
